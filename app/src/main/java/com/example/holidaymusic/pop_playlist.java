...
public class pop_playlist extends AppCompatActivity {
    private MediaPlayer mpPop_playlist1;
    private MediaPlayer mpPop_playlist2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first_sample = findViewById(R.id.tvPopSample3);
        second_sample = findViewById(R.id.tvPopSample4);

        mpPop_playlist1 = MediaPlayer.create(this, R.raw.pop_playlist1);
        mpPop_playlist2 = MediaPlayer.create(this, R.raw.pop_playlist2);
