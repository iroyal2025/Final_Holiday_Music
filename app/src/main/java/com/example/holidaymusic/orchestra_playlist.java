...
public class orchestra_playlist extends AppCompatActivity {
    private MediaPlayer mpOrchestra_playlist1;
    private MediaPlayer mpOrchestra_playlist2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        first_sample = findViewById(R.id.tvOrchestraSample3);
        second_sample = findViewById(R.id.tvOrchestraSample4);
        mpOrchestra_playlist1  = MediaPlayer.create(this, R.raw.orchestra_playlist1);
        mpOrchestra_playlist2 = MediaPlayer.create(this, R.raw.orchestra_playlist2);
